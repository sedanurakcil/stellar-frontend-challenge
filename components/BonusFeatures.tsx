...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className=" w-12 h-12 rounded-xl flex items-center justify-center  bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 transition-colors"
